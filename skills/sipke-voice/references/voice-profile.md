...
Derived on 2026-08-29 from `valence-works/groundwork-v2`, the corpus this voice
is documented in: 50 commit subjects, `AGENTS.md`, `README.md`, ~36,000 words of
`docs/wiki/`, and the `docs/v2/releases/` notes. Every claim below is followed by
evidence from that corpus. Nothing here comes from an assistant's prior memory —
...
- The corpus is one project's technical writing. It says nothing
